...
class ErrorHandler {
	...
	handleNetworkError(_error: Error, context?: string): void {
		this.addError({
	...
	handleStorageError(_error: Error, context?: string): void {
		this.addError({
	...
	handleFileError(_error: Error, context?: string): void {
		this.addError({
...
export function useErrorHandler() {
	return {
		...
		setupGlobalErrorHandling: errorHandler.setupGlobalErrorHandling.bind(errorHandler),
	};
}
