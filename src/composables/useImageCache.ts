...
export function useImageCache() {
	...
	async function loadImage(imageId: string, loadFunction: () => Promise<string>): Promise<string> {
		// Check cache first
	...
	function preloadImage(imageId: string, loadFunction: () => Promise<string>): void {
